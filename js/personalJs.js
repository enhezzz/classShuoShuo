...
//     { title: "shuoshuo" },
//     "",
//     "/classShuoShuo/homePage/shuoshuo"
//   );
...
$('.profile__heading-edit--init').on('click',function() {
    $(this).next().css('display', 'inline-block')
});
$('#save_class').on('click',function() {
    // const that = this;
    $.get('/classShuoShuo/editClass',{class: $('#class').val()},(res) => {
        $('#classname').text(res);
        this.parentNode.style.display = 'none';
    })
})
$('#save_site').on('click',function() {
    // const that = this;
    $.get('/classShuoShuo/editSite',{site: $('#site').val()},(res) => {
        $('#siteName').text(res);
        this.parentNode.style.display = 'none';
    })
})
...
$('#article').on('click',function() {
  $.get('/classShuoShuo/homePage/article',function(res) {
    $('#content').html(res);
  },'html')
});
$('#shuoshuo').on('click',function() {
  $.get('/classShuoShuo/homePage/shuoshuo',function(res) {
    console.log(res);
    $('#content').html(res);
  },'html')
})
