...
$('.comment').on('click', function (e) {
    ...
    fetch("/classShuoShuo/trends/comment", {
        ...
        $(_this).parent().parent().parent().prev().css('display', 'none');
        date.json().then(function (result) {
            $(_this).parent().parent().parent().prev().prev().append("<div class=\"row\">\n    <p class=\"col-xs-10 col-sm-10 col-md-10\">\n        \n        " + $(_this).siblings('.form-group').children()[0].value + "<br>\n        " + result + "\n    </p>\n</div>");
            console.log(result);
        });
